				...
				<div class="col-12">
					<div class="testimonial-slider">
						...
						<div class="single-testimonial">
							<img src="<?php bloginfo('template_directory'); ?>/images/testimonial1.jpg" alt="#">
						...
						<!-- Single Testimonial -->
						<div class="single-testimonial">
							<img src="<?php bloginfo('template_directory'); ?>/images/testimonial2.jpg" alt="#">
							<div class="main-content">
						...
						<!-- Single Testimonial -->
						<div class="single-testimonial">
							<img src="<?php bloginfo('template_directory'); ?>/images/testimonial3.jpg" alt="#">
							<div class="main-content">
								<h4 class="name">Sanavce Faglane</h4>
								<p>Nulla cursus a metus vel placerat. Fusce malesuada volutpat pretium. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus velit libero, viverra quis euismod vel pellentesque at tortor. Donec</p>
							</div>
						...
						<!-- Single Testimonial -->
						<div class="single-testimonial">
							<img src="<?php bloginfo('template_directory'); ?>/images/testimonial4.jpg" alt="#">
							<div class="main-content">
								<h4 class="name">Jansan Kate</h4>
								<p>Nulla cursus a metus vel placerat. Fusce malesuada volutpat pretium. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus velit libero, viverra quis euismod vel pellentesque at tortor. Donec</p>
							</div>
